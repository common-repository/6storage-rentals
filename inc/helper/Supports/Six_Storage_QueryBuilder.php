...
namespace SixStorageOnline\helper\Supports\QueryBuilder;

use Toolkit\helper\Supports\TableInfo;
 ...
 */
class Six_Storage_QueryBuilder {
	 ...
	 * @return static
	 */
	public static function table( string $table ): Six_Storage_QueryBuilder {
	 ...
	 * @return static
	 */
	public function order_by( string $column, string $order = 'DESC' ): Six_Storage_QueryBuilder {
	 ...
	 * @return static
	 */
	public function in_random_order(): Six_Storage_QueryBuilder {
	 ...
	 * @return static
	 */
	public function offset( int $offset = 0 ): Six_Storage_QueryBuilder {
	 ...
	 * @return static
	 */
	public function limit( int $limit ): Six_Storage_QueryBuilder {
	 ...
	 * @return static
	 */
	public function page( int $page ): Six_Storage_QueryBuilder {
		if ( $this->query['limit'] > 0 ) {
			$page = max( 1, $page );
	 ...
	 * @return $this
	 */
	public function group_by( $group_by ): Six_Storage_QueryBuilder {
	 ...
	 * @return $this
	 */
	public function where( $column, $value = '', $compare = '=', $relation = 'AND' ): Six_Storage_QueryBuilder {
		$args  = func_get_args();
		$where = [];
		if ( is_array( $args[0] ) ) {
	 ...
	 * @return $this
	 */
	public function select( $columns = [ '*' ] ): Six_Storage_QueryBuilder {
	 ...
	 * @return static
	 */
	public function join( string $table, string $first_column, string $second_column, string $type = 'INNER' ): Six_Storage_QueryBuilder {
